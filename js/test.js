...
function scene2() {
	...
	$('#scene2').delay(12000).fadeOut(1000).delay(1000).queue(function(next) {
		scene3();
		next();
	});
}
  ...
  function scene3() {
    ...
    timer+=2000;
    $('.ai').delay(timer-6000).queue(function(next){
  ...
  function scene4() {
    ...
    $('.scene4Bottom').delay(timer).fadeIn(1000);
		...
		if(reactAnswer === "A") {
			...
			strings: [name + ": Get lost"],
				...
				$('.bumResponses').typed({
				strings: ["Bum: You get lost,^1000 you gentrifying punk! <br>"],
					typeSpeed: 20,
					startDelay: 4000,
					showCursor: false
				});
			...
			$('.userResponses').typed({
			strings: [name + ": Don't make me call the cops."],
				typeSpeed: 20,
				startDelay: 2000,
				showCursor: false
			});
				$('.bumResponses').typed({
				strings: ["Bum: Good!^500 I'd like to have a bed and a hot meal anyways!"],
					typeSpeed: 20,
					startDelay: 4000,
					showCursor: false
				});
    ...
    $('#scene4').delay(8000).fadeOut(1000).delay(1000).queue(function(next) {
      scene5();
      next();
    });
  });
    ...
    $("#puzzleTwoSubmit").click(function(event) {
      ...
      if(riddle2) {
        ...
        $('.riddle2ResponseText').typed({
          ...
          startDelay: 1000,
          showCursor: false
        }).delay(22000).queue(function(next) {
          scene7();
          next();
